...
window.CXHUB_CONFIG = {
  ...
  /* Characters. Replace the PNGs in assets/characters/ with real character art,
     or point img -> a hosted URL, or use a Lottie. Add/remove freely. */
  CHARS: {
    m: [
      { id:"m1", img:"assets/characters/m1.png", name:{en:"Omar",   ar:"عمر"} },
      { id:"m2", img:"assets/characters/m2.png", name:{en:"Sami",   ar:"سامي"} },
      { id:"m3", img:"assets/characters/m3.png", name:{en:"Ali",    ar:"علي"} },
      { id:"m4", img:"assets/characters/m4.png", name:{en:"Yousef", ar:"يوسف"} }
    ],
    f: [
      { id:"f1", img:"assets/characters/f1.png", name:{en:"Layla", ar:"ليلى"} },
      { id:"f2", img:"assets/characters/f2.png", name:{en:"Noor",  ar:"نور"} },
      { id:"f3", img:"assets/characters/f3.png", name:{en:"Sara",  ar:"سارة"} },
      { id:"f4", img:"assets/characters/f4.png", name:{en:"Hana",  ar:"هناء"} }
    ]
  },
