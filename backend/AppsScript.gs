...
var SECRET_TOKEN = "CHANGE-ME-CXHUB-2026";   // <-- change, and match in cxhub-sync.js

var PROFILE_HEADERS  = ["Timestamp","EmpID","Name","Brand","Division","Gender","Character","Lang","ClientTime"];
var RESULT_HEADERS   = ["Timestamp","EmpID","Name","Brand","Division","World","LevelID","Score","Stars","Passed","Attempt","DurationSec","Lang","ClientTime","Meta"];
var FEEDBACK_HEADERS = ["Timestamp","EmpID","Name","Brand","Division","World","LevelID","Rating","Comment","Lang","ClientTime"];
...
function doPost(e){
  ...
  if (d.action === "feedback"){
    ensureTab(ss, "Feedback", FEEDBACK_HEADERS).appendRow([
      now, d.empId||"", d.name||"", d.brand||"", d.division||"", d.world||"", d.levelId||"",
...
function upsertProfile(ss, d, now){
  ...
  var vals = [now, d.empId||"", d.name||"", d.brand||"", d.division||"", d.gender||"", d.character||"", d.lang||"", d.clientTime||""];
